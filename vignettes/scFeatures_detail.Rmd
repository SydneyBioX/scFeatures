...
scfeatures_result <- scFeatures(data,
    ...
    # When passing as SingleCellExperiment or SpatialExperiment,
    # by default we use the assay stored in "logcount"
    assay = "norm",
    # By default we look for the sample info in "sample" column and the
    # celltype info in "celltype" column
    sample = "imageID",
    celltype = "cellType",
    #  If users want to construct features from the spatial metrics
    # category, by default we look for the "x_cord" & "y_cord" column
    spatialCoords = c("x", "y"),
