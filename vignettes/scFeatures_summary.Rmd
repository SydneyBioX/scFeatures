...
vignette: >
  %\VignetteIndexEntry{Overview of scFeatures functions}
...
```{r, run-various-features, include=TRUE, warning=FALSE, message=FALSE, eval=FALSE}
#---------------------------------------------------------------------------
# read in data
#---------------------------------------------------------------------------
data("example_scrnaseq" , package = "scFeatures")
...
#---------------------------------------------------------------------------
# optional step, run if mitochondria and ribosomal genes are not of interest
...
```{r, run-spatial-p, include=TRUE, warning=FALSE, message=FALSE, eval=FALSE}
#---------------------------------------------------------------------------
# read in data
#---------------------------------------------------------------------------
...
```{r, run-spatial-t, include=TRUE, warning=FALSE, message=FALSE, eval=FALSE}
#---------------------------------------------------------------------------
# read in data
#---------------------------------------------------------------------------
data("example_scrnaseq" , package = "scFeatures")
