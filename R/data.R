...
#'
#' This is a subsampled version of the melanoma patients dataset as used in our manuscript.
#' The original dataset is available at <https://www.ncbi.nlm.nih.gov/geo/query/acc.cgi?acc=GSE120575>.
#'  
